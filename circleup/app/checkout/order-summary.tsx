...
const styles = StyleSheet.create({
  ...
  itemHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 15, width: '100%' },
  itemName: { fontSize: normalize(16), fontWeight: '800', color: COLORS.primary, flex: 1, flexShrink: 1, marginRight: 8 },
